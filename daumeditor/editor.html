	...
	<form name="tx_editor_form" id="tx_editor_form" action="http://posttestserver.com/post.php" method="post" accept-charset="utf-8">
		...
		<div id="tx_trex_container" class="tx-editor-container">
			...
			<div id="tx_toolbar_basic" class="tx-toolbar tx-toolbar-basic"><div class="tx-toolbar-boundary">
                ...
                <ul class="tx-bar tx-bar-left">
					<li class="tx-list">
						<div id="tx_paste" unselectable="on" class="tx-slt-31bg tx-paste">
							<a href="javascript:;" class="tx-icon" title="클립보드 붙여넣기">클립보드 붙여넣기</a>
						</div>
						<div id="tx_paste_menu" class="tx-menu tx-paste-menu" unselectable="on"></div>
					</li>
				</ul>
				<ul>
					<li class="tx-list">
						<div id="tx_codehighlight" unselectable="on" class="tx-btn-lrbg tx-sourcecode">
							<a href="javascript:;" class="tx-icon" title="소스코드 첨부">소스코드 첨부</a>
						</div>
					</li>
                </ul>
				<ul class="tx-bar tx-bar-right">
			...
			<div id="tx_toolbar_advanced" class="tx-toolbar tx-toolbar-advanced"><div class="tx-toolbar-boundary">
                ...
                <ul class="tx-bar tx-bar-left">
                    <li class="tx-list">
						<div id="tx_tableresize" unselectable="on" class="tx-btn-lrbg tx-cellsize">
							<a href="javascript:;" class="tx-icon2" title="셀크기 변경">셀크기 변경</a>
						</div>
                        <div id="tx_tableresize_menu" class="tx-cellsize-menu tx-menu2 tx-cellsize" unselectable="on"></div>
                    </li>
                </ul>
                <ul class="tx-bar tx-bar-left">
					<li class="tx-list">
						<div id="tx_tablevalign" unselectable="on" class="tx-btn-lrbg tx-cellvalign">
							<a href="javascript:;" class="tx-icon2" title="셀내용 세로 정렬">셀내용 세로 정렬</a>
						</div>
						<div id="tx_tablevalign_menu" class="tx-cellvalign-menu tx-menu tx-cellvalign" unselectable="on">
