 ...
 *
 * Copyright (c) 2009 John Resig, J철rn Zaefferer
...
var QUnit = {
	...
	test: function(testName, expected, callback, async) {
		var name = '<span class="test-name">' + escapeHtml(testName) + '</span>', testEnvironment, testEnvironmentArg;
...
addEvent(window, "load", function() {
	...
	if ( banner ) {
		...
		banner.innerHTML += ' <a href="' + location.pathname + '">(All Tests)</a>';
	}
