...
var QUnit = {
	...
	test: function(testName, expected, callback, async) {
		var name = '<span class="test-name">' + escapeHtml(testName) + '</span>', testEnvironmentArg;
...
addEvent(window, "load", function() {
	...
	if ( banner ) {
		banner.innerHTML = '<a href="' + QUnit.url() + '"> ' + banner.innerHTML + '</a> ' +
        ...
        banner.innerHTML += ' <a href="' + QUnit.url({ filter: undefined }) + '">(All Tests)</a>';
